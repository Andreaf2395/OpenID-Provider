...
class OAuth2ClientMixin(ClientMixin):
    ...
    client_id_issued_at = models.IntegerField(null=False,default=0)
    client_secret_expires_at = models.IntegerField(null=False, default=0)
    _client_metadata = models.TextField(db_column='client_metadata')
